...
namespace Auction_Boxing_3.Animation
{
    /// <summary>
    ...
    public struct AnimationPlayer
    {
        ...
        /// </summary>
        public void Draw(GameTime gameTime, SpriteBatch spriteBatch, Color color, Vector2 position, float rotation, float scale, SpriteEffects spriteEffects)
        {
            if (Animation == null)
        ...
        /// <summary>
        /// Draws the current frame of the animation. Alternate function allows
